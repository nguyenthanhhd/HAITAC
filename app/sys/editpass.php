...
<div class="container-layout margin-big-top">
    <div class="line  form-x">
    	...
    	<div class="margin-big-top text-center"><button class="button button-block bg-sub text-big" type="button" onclick="Ajax_Action('EditPass')"  >Thay Đổi Mật Khẩu</button></div>
	</div>
</div>
</body>
</html>